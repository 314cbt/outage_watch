...
class WorkOrdersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create work_order" do
    assert_difference("WorkOrder.count") do
      post work_orders_url, params: { work_order: { asset_id: @work_order.asset_id, description: @work_order.description, scheduled_for: @work_order.scheduled_for, status: @work_order.status, title: @work_order.title } }
    end
  ...
  test "should update work_order" do
    patch work_order_url(@work_order), params: { work_order: { asset_id: @work_order.asset_id, description: @work_order.description, scheduled_for: @work_order.scheduled_for, status: @work_order.status, title: @work_order.title } }
