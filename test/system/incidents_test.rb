...
class IncidentsTest < ApplicationSystemTestCase
  ...
  test "should create incident" do
    ...
    fill_in "Asset", with: @incident.asset_id
    fill_in "Cause", with: @incident.cause
    fill_in "Notes", with: @incident.notes
    fill_in "Resolved at", with: @incident.resolved_at
    fill_in "Severity", with: @incident.severity
    fill_in "Started at", with: @incident.started_at
  ...
  test "should destroy Incident" do
    visit incident_url(@incident)
    accept_confirm { click_on "Destroy this incident", match: :first }
