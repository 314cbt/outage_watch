...
class AssetsTest < ApplicationSystemTestCase
  ...
  test "should create asset" do
    ...
    fill_in "Latitude", with: @asset.latitude
    fill_in "Longitude", with: @asset.longitude
    fill_in "Metadata", with: @asset.metadata
  ...
  test "should destroy Asset" do
    visit asset_url(@asset)
    accept_confirm { click_on "Destroy this asset", match: :first }
